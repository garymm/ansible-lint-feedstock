...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/ansible-lint-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/ansible-lint-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add ansible-lint
# for installing globally
pixi global install ansible-lint
```
...
It is possible to list all of the versions of `ansible-lint` available on your platform:
...
```
pixi search ansible-lint --channel conda-forge
```
